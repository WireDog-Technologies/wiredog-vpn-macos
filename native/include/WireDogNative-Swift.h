...
#ifndef WIREDOGNATIVE_SWIFT_H
#define WIREDOGNATIVE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WireDogNative",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13WireDogNative22FilterExtensionManager")
@interface FilterExtensionManager : NSObject
- (void)loadManagerWithCompletion:(void (^ _Nonnull)(NSError * _Nullable))completion;
...
- (void)startFilterWithMode:(NSString * _Nonnull)mode apps:(NSArray * _Nonnull)apps completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
...
SWIFT_CLASS("_TtC13WireDogNative14StatusObserver")
@interface StatusObserver : NSObject
- (nonnull instancetype)initWithConnection:(NEVPNConnection * _Nullable)connection callback:(void (^ _Nonnull)(NSString * _Nonnull))callback OBJC_DESIGNATED_INITIALIZER;
/// Convert NEVPNStatus enum to JavaScript-friendly string
+ (NSString * _Nonnull)statusStringFrom:(NEVPNStatus)status SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC13WireDogNative13TunnelManager")
@interface TunnelManager : NSObject
/// Callback invoked when tunnel status changes
@property (nonatomic, copy) void (^ _Nullable onStatusChange)(NSString * _Nonnull);
/// Load or create the VPN configuration profile
- (void)loadManagerWithCompletionHandler:(void (^ _Nonnull)(NSError * _Nullable))completionHandler;
/// Start the VPN tunnel with the given WireGuard configuration
- (BOOL)startTunnelWithConfig:(NSDictionary<NSString *, id> * _Nonnull)config error:(NSError * _Nullable * _Nullable)error;
/// Stop the VPN tunnel
- (void)stopTunnel;
...
- (void)getStatsWithCompletion:(void (^ _Nonnull)(NSError * _Nullable, NSNumber * _Nullable, NSNumber * _Nullable))completion;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
