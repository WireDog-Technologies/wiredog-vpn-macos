...
// Mirrors iOS's BroadcastService: poll every 5 minutes (+ jitter) while the app is active,
// pause while backgrounded — react-query's refetchIntervalInBackground: false gives us the
// pause-when-unfocused behavior for free.
...
export function useAnnouncements() {
  ...
  // client-side lifecycle filtering, matches iOS.
