...
import { Power, Split, User, Bell, ChevronLeft, Globe, RotateCcw, Download, Loader2, CheckCircle, Lock, ShieldCheck } from 'lucide-react';
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold tracking-wider text-muted-foreground/60 border border-border rounded px-1">COMING SOON</span>
                  </div>
