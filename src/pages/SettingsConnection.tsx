...
import { isMac, trayLabel } from '@/lib/platform';
...
const SettingsConnection: React.FC = () => {
  ...
  const startupLabel = isMac ? 'Open at Login' : 'Auto-Startup';
        ...
        <Card className="p-4 mb-4">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium leading-tight">{startupLabel}</p>
          ...
          {electronSettings.autoStart && (
            <div className="mt-3 space-y-2">
              {/* Minimize to Tray/Menu Bar Option */}
              <button
                onClick={(e) => {
                  e.stopPropagation();
              ...
              >
                <p className="font-medium leading-tight">Minimize to {trayLabel}</p>
                <p className="text-sm text-muted-foreground leading-tight">App starts hidden in the {trayLabel.toLowerCase()}</p>
              </button>
