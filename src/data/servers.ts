...
export const servers: ServerLocation[] = [
  { id: 'ny-1', state: 'New York', stateCode: 'NY', city: 'New York City', latitude: 40.7128, longitude: -74.006, latency: 0, load: 45, host: '', recommended: true },
  { id: 'ca-1', state: 'California', stateCode: 'CA', city: 'Los Angeles', latitude: 34.0522, longitude: -118.2437, latency: 0, load: 62, host: '' },
  { id: 'ca-2', state: 'California', stateCode: 'CA', city: 'San Francisco', latitude: 37.7749, longitude: -122.4194, latency: 0, load: 38, host: '', recommended: true },
  ...
  { id: 'fl-1', state: 'Florida', stateCode: 'FL', city: 'Miami', latitude: 25.7617, longitude: -80.1918, latency: 0, load: 68, host: '', recommended: true },
  ...
  { id: 'va-1', state: 'Virginia', stateCode: 'VA', city: 'Richmond', latitude: 37.5407, longitude: -77.436, latency: 0, load: 56, host: '', recommended: true },
